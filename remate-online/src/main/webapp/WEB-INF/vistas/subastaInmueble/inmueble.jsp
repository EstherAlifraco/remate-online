...
<t:nav-footer>
   ...
   <div class="texto">
	<br>
	La Calle es: ${inmueble.calle} N°: ${inmueble.numero}
	<br>
	Cantidad de Habitaciones: ${inmueble.habitaciones}
	<br>
	La Localidad es: ${inmueble.localidad}
	<br>
	La Ciudad Es: ${inmueble.ciudad}
	<br>
	<br>
	<br>
	<br>
...
<p id="demo"></p>
<br>
     El Precio es:${inmueble.subastaInmueble.precioBase}
     <br>
	 <br>
	 Descripción: ${inmueble.subastaInmueble.descripcion}
	 <br>
	 <br>
...
//Establece la fecha.
var countDownDate = new Date("${inmueble.subastaInmueble.fechaInicio}").getTime();
