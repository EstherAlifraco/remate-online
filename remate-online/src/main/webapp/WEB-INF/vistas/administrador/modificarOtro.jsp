...
<t:nav-admin>
	...
	<form:form action="actualizarOtro" modelAttribute="otro"
		method="POST">
		<div class="form-row">
			<div class="form-group col-md-12">
				<div class="form-group col-md-12">
					...
					<form:input type="text" required="required" class="form-control"
						id="nombre" name="nombre" path="nombre" />
				</div>
				<div class="form-group col-md-12">
					<label for="descripcion">Descripcion</label>
					<form:input type="text" required="required" class="form-control"
						id="descripcion" name="descripcion" path="descripcion" />
				</div>

					<div class="form-group col-md-12">
					<label for="tipoOtro">Tipo del Articulo</label> <select	 id="subOtroId" name="subOtroId" class="form-control">
